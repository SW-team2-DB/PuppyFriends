...
public class ChatInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_in);
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                imgRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(ChatInActivity.this, "프로필 저장 완료", Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent=new Intent(ChatInActivity.this, ChatActivity.class);
                        startActivity(intent);
                        finish();
