...
public class ExpandAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<AddrGroup> DataList;
    private LayoutInflater myinf = null;

    public ExpandAdapter(Context context, int groupLay, int chlidLay, ArrayList<AddrGroup> DataList){
    ...
    @Override
    public AddrGroup getGroup(int groupPosition) {
        // TODO Auto-generated method stub
